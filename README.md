...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/newversion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14486&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/newversion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `newversion` can be installed with:

```
conda install newversion
```

It is possible to list all of the versions of `newversion` available on your platform with:
